...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/data/localhome/tkapoor/PycharmProjects/causal_timoshenkp/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/data/localhome/tkapoor/PycharmProjects/causal_timoshenkp/venv/bin/deactivate.nu'
