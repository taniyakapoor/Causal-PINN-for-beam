...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/data/localhome/tkapoor/PycharmProjects/PINN_timo/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/data/localhome/tkapoor/PycharmProjects/PINN_timo/venv/bin/deactivate.nu'
