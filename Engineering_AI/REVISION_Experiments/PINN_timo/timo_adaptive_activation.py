...
# with open('PINN_tim_adaptive_new.pkl', 'wb') as f:
...
# torch.save(model_state_dict, 'PINN_tim_adaptive_new.pth')


# # Load the history from the pickle file
# with open('PINN_tim_adaptive_new.pkl', 'rb') as f:
...
# model_state_dict = torch.load('PINN_tim_adaptive_new.pth', map_location=torch.device('cpu'))
...
plt.savefig('PINN_timo_disp_adaptive_new.png', dpi=500, bbox_inches="tight", format='png')
...
# plt.xticks(fontsize=font_size, fontproperties=ticks_font)
# plt.yticks(fontsize=font_size, fontproperties=ticks_font)
plt.savefig('PINN_timo_rotation_adaptive_new.png', dpi=500, bbox_inches="tight", format='png')
